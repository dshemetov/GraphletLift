...
def test_big_graph(name, triangle_count):
...
# run_test(nx.ladder_graph(4),2)


# SMALL GRAPH TESTS TESTS
test_path_graph()
test_wheel_graph()
test_ladder_graph()
...
test_big_graph("bio-celegansneural", 9900)
# # http://networkrepository.com/ia-email-univ.php
test_big_graph("ia-email-univ", 16000)
# http://networkrepository.com/fullb.php
# test_big_graph("misc-fullb", 180.6 * 10**6)
